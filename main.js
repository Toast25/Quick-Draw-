...
Sketch_drawn = quick_draw_data_set[random_num];
document.getElementById('span3').innerHTML = Sketch_drawn;
timer_counter = 0;
timer_check="";
drawn_sketch="";
answer_holder="";
...
function sketch(){
    ...
    document.getElementById("span1").innerHTML = timer_counter;
...
function Gotresults(error, result) {
    if (error) {
        ...
        document.getElementById("span4").innerHTML = drawn_sketch;
        document.getElementById("span5").innerHTML = Math.round(result[0].confidence*100) + "%";
    }
}